<div class="modal fade" id="fundWalletModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="processes/process-wallet.php" method="post">
                    ...
                    <div>
                        <button type="submit" name="fund" class="btn btn-dark btn-sm">Fund</button>
                    </div>
                </form>
            </div>
